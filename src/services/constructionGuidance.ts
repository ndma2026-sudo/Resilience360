...
export const generateConstructionGuidance = async (payload: {
  ...
  return parseJsonResponse<ConstructionGuidanceResult>(response, 'AI guidance generation failed')
}
...
export const generateGuidanceStepImages = async (payload: {
  ...
  return parseJsonResponse<{ images: GuidanceStepImage[] }>(response, 'AI step image generation failed')
}
